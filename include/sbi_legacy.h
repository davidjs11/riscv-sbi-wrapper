...
/* SBI Spec. ver 3.0 - Section 5.8 */
static inline long sbi_remote_sfence_vma_asid(
        uintptr_t hart_mask,
        uintptr_t start,
        uintptr_t size,
        uintptr_t asid)
